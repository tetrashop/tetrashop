...
```bash
git clone https://github.com/tetrashop/tetrashop.git
cd tetrashop
# دستورات نصب
```
...
- **URL:** [  🚀 دیپلوی tetrashop روی Vercel...
    ❌ دیپلوی ناموفق!
...
✓ Linked          ramin-edjlal-s-projects/tetrashop

Retrieving project…
> Downloading `development` environment variables for ramin-edjlal-s-projects/tetrashop
Downloading

✓ Created         .env.local file and added it to .gitignore
Deploying ramin-edjlal-s-projects/tetrashop
Uploading [--------------------] (0.0B/3.8KB)
Uploading [====================] (3.8KB/3.8KB)
Error: Resource is limited - try again in 24 hours (more than 100, code: "api-deployments-free-per-day").](  🚀 دیپلوی tetrashop روی Vercel...
    ❌ دیپلوی ناموفق!
error: "/data/data/com.termux/files/usr/lib/node_modules/vercel/dist/get-latest-worker.cjs" has bad ELF magic: 2f2a2a0a
Vercel CLI 58.5.1 (Node.js 26.4.0)
...
<!-- Trigger deploy: Mon Aug 17 01:50:38 +0330 2026 -->

## 🌐 دیپلوی

- **URL:** [https://tetrashop.vercel.app](https://tetrashop.vercel.app)
- **وضعیت:** ✅ فعال
